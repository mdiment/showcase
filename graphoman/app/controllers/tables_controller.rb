class TablesController < ApplicationController
  ...
  def index
    @tables = Table.where(user_id: current_user)
  end
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to root_url, notice: "Table was successfully destroyed." }
  ...
  private
    ...
    def table_params
      params.require(:table).permit(:func, :result, :lower_x, :upper_x)
    end
end
