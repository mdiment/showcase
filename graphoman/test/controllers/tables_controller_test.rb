...
class TablesControllerTest < ActionDispatch::IntegrationTest
  ...
  #     post tables_url, params: { table: { func: @table.func, lower_x: @table.lower_x, result: @table.result, upper_x: @table.upper_x } }
  #   end
  ...
  #   patch table_url(@table), params: { table: { func: @table.func, lower_x: @table.lower_x, result: @table.result, upper_x: @table.upper_x } }
